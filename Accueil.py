...
st.set_page_config(
    page_title="AlgoLab — Visualisateur d'Algorithmes",
    page_icon="⚡",
    layout="wide",
...
st.markdown('<div class="hero-title">AlgoLab</div>', unsafe_allow_html=True)
...
with c1:
    st.markdown('<div class="stat-box"><div class="stat-num">4</div><div class="stat-label">Catégories</div></div>', unsafe_allow_html=True)
with c2:
    st.markdown('<div class="stat-box"><div class="stat-num">10+</div><div class="stat-label">Algorithmes</div></div>', unsafe_allow_html=True)
with c3:
...
st.markdown("<hr class='divider'>", unsafe_allow_html=True)
st.markdown('<p style="color: #64748b; font-size: 0.8rem; font-family: \'Space Mono\', monospace; text-align:center;">AlgoLab · Construit avec Python & Streamlit</p>', unsafe_allow_html=True)
